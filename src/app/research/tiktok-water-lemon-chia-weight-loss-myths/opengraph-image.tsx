...
export const alt =
  "Weight Loss Rankings — TikTok water, lemon, and chia weight-loss myths busted";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 18, marginTop: 12 }}>
            ...
            <div style={{ display: "flex", fontSize: 28, fontWeight: 600, opacity: 0.9, paddingBottom: 12, maxWidth: 700 }}>
              TikTok hacks have human RCT weight evidence beyond plain water · Abou-Khalil 2024 ACV retracted
            </div>
          </div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", opacity: 0.85, fontSize: 24 }}>
          ...
          <div style={{ display: "flex" }}>7 PubMed-verified citations · 2026-04-08</div>
        </div>
      </div>
    ),
    size,
