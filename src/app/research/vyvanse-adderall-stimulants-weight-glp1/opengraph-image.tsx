...
export const alt =
  "Weight Loss Rankings — Vyvanse, Adderall, and stimulants for weight loss";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 18, marginTop: 12 }}>
            ...
            <div style={{ display: "flex", fontSize: 28, fontWeight: 600, opacity: 0.9, paddingBottom: 12, maxWidth: 700 }}>
              FDA-approved weight-loss indications across both drugs · Vyvanse on-label only for binge-eating disorder
            </div>
          </div>
        </div>
