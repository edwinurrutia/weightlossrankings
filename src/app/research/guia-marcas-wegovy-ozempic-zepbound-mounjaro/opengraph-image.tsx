...
// Per-route OG image for
// /research/guia-marcas-wegovy-ozempic-zepbound-mounjaro (Spanish).
// Mirrors the safari-safe flex-everywhere pattern used by the other
// Spanish research OG images.
...
export default async function Image() {
  ...
  const title = article?.title ?? "Guía de marcas de GLP-1";
