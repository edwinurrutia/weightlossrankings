...
export const alt =
  "Weight Loss Rankings — Antidepressants and weight on a GLP-1: SSRIs, Wellbutrin, and the evidence";
    ...
    (
      <div
        style={{
          ...
          height: "100%",
          background:
            "linear-gradient(135deg, #1e1b4b 0%, #6d28d9 50%, #3b82f6 100%)",
          display: "flex",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ display: "flex", fontSize: 28, fontWeight: 600, opacity: 0.9, textTransform: "uppercase", letterSpacing: 2 }}>
            Gafoor 2018 BMJ · COR-I · EMA PRAC 2024
          </div>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 18, marginTop: 12 }}>
            ...
            <div style={{ display: "flex", fontSize: 28, fontWeight: 600, opacity: 0.9, paddingBottom: 12, maxWidth: 700 }}>
              FDA-labeled antidepressant interactions across Wegovy, Ozempic, Mounjaro, Zepbound, and Foundayo
            </div>
          </div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", opacity: 0.85, fontSize: 24 }}>
          ...
          <div style={{ display: "flex" }}>13 PubMed-verified citations · 2026-04-07</div>
        </div>
      </div>
    ),
    size,
