...
export const alt =
  "Weight Loss Rankings — Switching between GLP-1 medications: complete protocol guide";
...
export default async function Image() {
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", background: "linear-gradient(135deg, #1e3a8a 0%, #4338ca 50%, #8b5cf6 100%)", display: "flex", flexDirection: "column", justifyContent: "space-between", color: "white", fontFamily: "sans-serif", padding: "72px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ display: "flex", fontSize: 28, fontWeight: 600, opacity: 0.9, textTransform: "uppercase", letterSpacing: 2 }}>
            Protocol guide · FDA label sourced
          </div>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 18, marginTop: 12 }}>
            <div style={{ display: "flex", fontSize: 156, fontWeight: 800, letterSpacing: -3, color: "#fbbf24", lineHeight: 1 }}>7</div>
            <div style={{ display: "flex", fontSize: 32, fontWeight: 600, opacity: 0.9, paddingBottom: 12, maxWidth: 700 }}>
              switching scenarios · sema ↔ tirz ↔ compounded ↔ oral
            </div>
          </div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", opacity: 0.85, fontSize: 24 }}>
          ...
          <div style={{ display: "flex" }}>Wegovy · Ozempic · Zepbound · Mounjaro · Foundayo</div>
        </div>
      </div>
    ),
    size,
