...
export const metadata: Metadata = {
  ...
  description:
    "WeightLossRankings is an independent review site that evaluates GLP-1 telehealth providers, weight loss programs, and supplements. Read the story behind the site, how it's built, and how it stays independent.",
