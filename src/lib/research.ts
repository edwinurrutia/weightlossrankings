...
export const RESEARCH_ARTICLES: ResearchArticle[] = [
  ...
  {
    slug: "glp1-units-to-mg-dosage-chart",
    title: "GLP-1 Units to mg Dosage Chart: Semaglutide & Tirzepatide",
    description:
    ...
    excerpt:
      "Compounded GLP-1 vials are labeled in mg/mL but drawn in U-100 insulin-syringe units, and getting the conversion wrong can mean a 2x or 5x dosing error. We publish the full reference table — every common dose at every common compounded concentration for both semaglutide and tirzepatide — plus the formula, worked examples for the highest-volume questions, and a link to our interactive calculator. The math is verified against the same engine that powers our /tools/glp1-unit-converter.",
    kind: "data-investigation",
    publishedDate: "2026-04-07",
    lastUpdated: "2026-04-07",
    readMinutes: 11,
  ...
  },
  {
    ...
    excerpt:
      "Semaglutide is sold under three brand names — Wegovy (weight loss), Ozempic (type 2 diabetes), and Rybelsus (oral diabetes pill) — plus a still-active 503A compounded market that survived the FDA shortage resolution in May 2025. This article walks through every legitimate US channel a patient can use to buy semaglutide in 2026: retail pharmacy with insurance, NovoCare Pharmacy direct-pay at $499/month, 503A compounded semaglutide via telehealth at $99-$249/month, and the insurance prior-authorization path. Pricing is verified from the FDA labels, the NovoCare patient site, and our live 80-provider compounded pricing dataset.",
    kind: "data-investigation",
    publishedDate: "2026-04-07",
    lastUpdated: "2026-04-07",
    readMinutes: 9,
    citations: 6,
    tags: ["Semaglutide", "Where to buy", "Pricing 2026", "Provider directory", "Buyer guide"],
  },
  {
    slug: "where-to-buy-tirzepatide",
    title:
    ...
    excerpt:
      "Tirzepatide is sold under two brand names — Zepbound for weight loss and Mounjaro for type 2 diabetes — plus a 503A compounded market that survived the FDA shortage resolution in late 2024. This article walks through every legitimate US channel a patient can use to buy tirzepatide in 2026: brand Zepbound through LillyDirect's single-dose vial program at $399-$499/month, Zepbound autoinjector pens at retail pharmacy at $1,000-$1,300/month cash, Mounjaro for diabetes patients (not FDA-approved for weight loss), and the 503A compounded tirzepatide path via telehealth. Pricing is verified from the FDA labels, the LillyDirect patient site, and our live 80-provider compounded pricing dataset.",
    kind: "data-investigation",
    publishedDate: "2026-04-07",
    lastUpdated: "2026-04-07",
    readMinutes: 9,
    citations: 6,
    tags: ["Tirzepatide", "Where to buy", "Pricing 2026", "Provider directory", "Buyer guide"],
  },
  {
